...
final List<MountModel> mountItems = [
  ...
  MountModel(
      ...
      name: 'Mount Merbaru',
      description:
      'Mount Merbabu is a dormant stratovolcano in Central Java province on the Indonesian island of Java. The name Merbabu could be loosely translated as Mountain of Ash from the Javanese ombined words; Meru means mountain and awu or abu means ash.',
